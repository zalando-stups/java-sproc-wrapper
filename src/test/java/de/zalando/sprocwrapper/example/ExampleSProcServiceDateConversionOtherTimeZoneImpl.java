 ...
 */
@Repository
public class ExampleSProcServiceDateConversionOtherTimeZoneImpl
    ...
    @Autowired
    public ExampleSProcServiceDateConversionOtherTimeZoneImpl(
            @Qualifier("testDataSourceProviderOtherTimeZone") final ArrayDataSourceProvider p) {
