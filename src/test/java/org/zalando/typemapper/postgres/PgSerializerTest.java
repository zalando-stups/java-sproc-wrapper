    ...
    public static Collection<Object[]> generateData() throws SQLException {
        ...
        return Arrays.asList(
                new Object[][]{
                        ...
                        {PgArray.ARRAY("a", "b").asJdbcArray("text"), "{a,b}"},
                        {PgArray.ARRAY("a", "b(x)").asJdbcArray("text"), "{a,b(x)}"},
                        {PgArray.ARRAY("a", "b{x}").asJdbcArray("text"), "{a,\"b{x}\"}"},
                        {
                        ...
                        {PgRow.ROW(1, 2), "(1,2)"},
                        {PgRow.ROW("a", "b{x}"), "(a,b{x})"},
                        {PgRow.ROW("a", "b(x)"), "(a,\"b(x)\")"},
                        {PgRow.ROW(1, 2, PgArray.ARRAY("a", "b")), "(1,2,\"{a,b}\")"},
                        {PgRow.ROW("a", "b", new int[]{1, 2, 3, 4}), "(a,b,\"{1,2,3,4}\")"},
                        {PgRow.ROW("a", null, PgArray.ARRAY(PgRow.ROW(1), PgRow.ROW(2), null)), "(a,,\"{(1),(2),NULL}\")"},
                        {
                                PgRow.ROW("a", null, PgArray.ARRAY(PgRow.ROW(1, 11), PgRow.ROW(2, 22), null)),
                                "(a,,\"{\"\"(1,11)\"\",\"\"(2,22)\"\",NULL}\")"
                        },
                });
    }
