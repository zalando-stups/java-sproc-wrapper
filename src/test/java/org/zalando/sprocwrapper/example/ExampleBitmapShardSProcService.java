...
public interface ExampleBitmapShardSProcService {
    ...
    @SProcCall(runOnAllShards = true, readOnly = false, shardedWriteTransaction = SProcCall.WriteTransaction.NONE)
