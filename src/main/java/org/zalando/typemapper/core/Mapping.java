...
public class Mapping {
    ...
    static List<Mapping> getMappingsForClass(final Class clazz, final boolean embed, final Field embedField) {
        ...
        for (final Field field : fields) {
            final DatabaseFieldDescriptor annotation = PgTypeHelper.getDatabaseFieldDescriptor(field);
            if (annotation != null) {
    ...
    public FieldMapper getFieldMapper() throws NotsupportedTypeException, InstantiationException,
        ...
        if (fieldMapper == null) {
            final DatabaseFieldDescriptor databaseFieldDescriptor = PgTypeHelper.getDatabaseFieldDescriptor(field);
