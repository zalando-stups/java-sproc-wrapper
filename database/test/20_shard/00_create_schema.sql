...
ALTER DEFAULT PRIVILEGES FOR ROLE api_owner IN SCHEMA ztest_shard REVOKE EXECUTE ON FUNCTIONS FROM public;
ALTER DEFAULT PRIVILEGES IN SCHEMA ztest_shard REVOKE EXECUTE ON FUNCTIONS FROM public;

ALTER DEFAULT PRIVILEGES FOR ROLE api_owner IN SCHEMA ztest_shard GRANT EXECUTE ON FUNCTIONS TO api_executor;

GRANT USAGE ON SCHEMA ztest_shard TO api_usage;
